	...
	<div class="row">
		<div class="col-md-6 product-single-gallery mb-md-0">
			<div class="product-slider-container">
				...
				<div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
					<div class="product-item">
						<img class="product-single-image" src="{{env('LANDING')}}/uploads/products/{{$product->fb_pixels}}"
							data-zoom-image="{{env('LANDING')}}/uploads/products/{{$product->fb_pixels}}" />
					</div>
					<div class="product-item">
						<img class="product-single-image" src="{{env('LANDING')}}/uploads/products/{{$product->thumbnail}}"
							data-zoom-image="{{env('LANDING')}}/uploads/products/{{$product->thumbnail}}" />
					</div>
					@if($product->image_one == null)

					@else
					<div class="product-item">
						<img class="product-single-image" src="{{env('LANDING')}}/uploads/products/{{$product->image_one}}"
							data-zoom-image="{{env('LANDING')}}/uploads/products/{{$product->image_one}}" />
					</div>
					@endif
					...
					@else
					<div class="product-item">
						<img class="product-single-image" src="{{env('LANDING')}}/uploads/products/{{$product->image_two}}"
							data-zoom-image="{{env('LANDING')}}/uploads/products/{{$product->image_two}}" />
					</div>
					@endif
					...
					@else
					<div class="product-item">
						<img class="product-single-image" src="{{env('LANDING')}}/uploads/products/{{$product->image_three}}"
							data-zoom-image="{{env('LANDING')}}/uploads/products/{{$product->image_three}}" />
					</div>
					@endif
			...
			<div class="prod-thumbnail owl-dots">
				<div class="owl-dot">
					<img width="150" src="{{env('LANDING')}}/uploads/products/{{$product->fb_pixels}}" />
				</div>
				<div class="owl-dot">
					<img width="150" src="{{env('LANDING')}}/uploads/products/{{$product->thumbnail}}" />
				</div>
				...
				@else
				<div class="owl-dot">
					<img src="{{env('LANDING')}}/uploads/products/{{$product->image_one}}" />
				</div>
				@endif
				...
				@else
				<div class="owl-dot">
					<img src="{{env('LANDING')}}/uploads/products/{{$product->image_two}}" />
				</div>
				@endif
				...
				@else
				<div class="owl-dot">
					<img src="{{env('LANDING')}}/uploads/products/{{$product->image_three}}" />
				</div>
				@endif
